...
\begin{figure}[ht]
    \centering
    \let\c@\includegraphics[height=2in]{Coflow_cct_fcfs_rate_jobrate_0_5.jpg}\relax
    \let\c@\includegraphics[height=2in]{Coflow_cct_mccft_rate_jobrate_0_5.jpg}\relax
    
    \let\c@\includegraphics[height=2in]{Coflow_cct_fcfs_rate.jpg}\relax
    \let\c@\includegraphics[height=2in]{Coflow_cct_mccft_rate.jpg}\relax
...
\begin{figure}[ht]
    \centering
    \let\c@\includegraphics[height=2in]{bw_statistics_fcfs.jpg}\relax
    \let\c@\includegraphics[height=2in]{bw_statistics_mcctf.jpg}\relax
...
\begin{figure}[ht]
    \centering
    \let\c@\includegraphics[height=2.5in]{Coflow_meancct_twoalgo_jobrate_0_5.jpg}\relax
    \let\c@\includegraphics[height=2.5in]{bw_utilize_rate_twoalgo_jobrate_0_5.jpg}\relax

    \let\c@\includegraphics[height=2.5in]{Coflow_meancct_twoalgo_jobrate_2_5.jpg}\relax
    \let\c@\includegraphics[height=2.5in]{bw_utilize_rate_twoalgo_jobrate_2_5.jpg}\relax
